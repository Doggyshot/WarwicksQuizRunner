...
The lite version exists if you don't mind always having to solve the captcha at the end of every quiz and on login, it takes up much less space than its auto-solve counterpart.
...
If you are still concerned, I encourage you to read through the source code (It's not very long, I promise) and compile the program yourself with the following command:
